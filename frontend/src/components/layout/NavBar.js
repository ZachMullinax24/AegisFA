  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ fontSize: '17px', fontWeight: '700', color: 'var(--text)', fontFamily: 'var(--font)', letterSpacing: '-0.3px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
          <div style={{
            ...
            background: backendOnline ? 'var(--accent)' : 'var(--red)',
            boxShadow: backendOnline ? '0 0 8px #00ff9daa' : '0 0 8px #ff555588',

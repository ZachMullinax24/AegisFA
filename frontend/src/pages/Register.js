...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      // Step 1 — validate access code (without user_id yet)
      ...
      // Step 3 — link user to org if we got a user id immediately
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: '2rem', background: 'var(--bg)' }}>
      ...
      <div className="card" style={{ width: '100%', maxWidth: '420px', padding: '2.25rem' }}>
        ...
        {success && (
          <Link to="/login" className="btn btn-primary" style={{ display: 'flex', justifyContent: 'center', marginTop: '1rem' }}>
            Go to Login
          </Link>
        )}
